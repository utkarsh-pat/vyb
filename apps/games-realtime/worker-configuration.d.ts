/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 79c13b4f7893b4487fd2d67c65929f0f)
// Runtime types generated with workerd@1.20260801.1 2026-08-08 nodejs_compat
interface __BaseEnv_Env {
	GAME_ALLOWED_ORIGINS: "http://localhost:3000,http://10.0.2.2:3000,https://vybnet.app,https://www.vybnet.app,https://vyb-vybnet.vercel.app";
	SOCIAL_FANOUT_SHARDS: "16";
	GAME_SESSION_SECRET: string;
	GAME_ROOMS: DurableObjectNamespace<import("./src/index").GameRoom>;
	SOCIAL_FEED_HUBS: DurableObjectNamespace<import("./src/index").SocialFeedHub>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GameRoom" | "SocialFeedHub";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GAME_ALLOWED_ORIGINS" | "SOCIAL_FANOUT_SHARDS" | "GAME_SESSION_SECRET">> {}
}
